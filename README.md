# The Application Package [![Build Status](https://ci.joomla.org/api/badges/joomla-framework/application/status.svg?ref=refs/heads/1.x-dev)](https://ci.joomla.org/joomla-framework/application)
